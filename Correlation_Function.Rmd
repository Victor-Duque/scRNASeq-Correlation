...
```{r Function}
Corr_Duq =function(Data, Identy, Subset, Target){
  RP_Final = data.frame()
  Start = Sys.time()
  Idents(Data) = Identy
...
#Data = Seurat Object
#Identy = Ident of Seurat object with you want to use for some Subset
#Subset = Cluster of analysis. OBS: If you want All cell, just put: NULL
#Target = Gene for correlation

Unspliced = Corr_Duq(Data = Seurat, Identy = "seurat_clusters", Subset = NULL, Target = "Avp")

Unspliced = Corr_Duq(Data = Seurat, Identy = "seurat_clusters", Subset = "1", Target = "Avp")

Unspliced = Corr_Duq(Data = Seurat, Identy = "seurat_clusters", Subset = "2", Target = "Avp")
```
